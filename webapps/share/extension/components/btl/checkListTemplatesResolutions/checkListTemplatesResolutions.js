(function () {
    ...
    YAHOO.extend(Alfresco.CheckListTemplatesResolutions, Alfresco.component.Base,
        {
            options: {
            ...
            calculateDate: function CheckListDeadlines_calculateDate(dayType, tasktime, nodeRef) {
                ...
                if (dayType == 1) {
                    ...
                    //datetext = curr_year + '-' + curr_month + '-' + curr_date;
                }
                else {
                    duration = tasktime;
                    if(tasktime) {
                    ...
                    // this.setCurrentEndDateValue(date,datetext);
