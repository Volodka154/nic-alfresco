...
define(["dojo/_base/declare",
    ...
    function (declare, Form, lang, domClass, $) {
        ...
        return declare([Form], {
             ...
             */
            cssRequirements: [{cssFile: "./css/pqgrid.css"},
                {cssFile: "./css/themes/Office/pqgrid.css"},
                {cssFile: "./css/ClassicWindow.css"},
                {cssFile: "./css/themes/Office/jquery-ui.css"},
                {cssFile: "./css/homeButton.css"},
                {cssFile: "/share/res/extension/css/icon.css"},
                {cssFile: "/share/res/extension/components/form/meetingMain.css"},
                {cssFile: "/share/res/extension/components/btl/windowChoiceItem/css/window_choice_item.css"}],
             ...
             * @default
             */
            subscriptionTopic: "BTL_DYNAMIC_FORM_UPDATE",
            ...
            onDynamicFormUpdate: function alfresco_forms_DynamicForm__onDynamicFormUpdate(payload) {
                ...
                if (!widgetModel) {
                    ...
                    if (this._form) {
                        this.alfLog("log", "alfresco_forms_DynamicForm__onDynamicFormUpdate this._form", this._form);
                    ...
                    try {
                        ...
                        if (this.formWidetsPropertyStringified) {
                            try {
                                this.alfLog("log", "alfresco_forms_DynamicForm__onDynamicFormUpdate", widgetModel);
                                var widgets = JSON.parse(widgetModel);
                                this.alfLog("log", "alfresco_forms_DynamicForm__onDynamicFormUpdate widgets", widgets);
                                this.processWidgets(widgets, this._form.domNode, "FIELDS");
                                if (widgets.length > 0) {
                                    domClass.remove(this.buttonsNode, "alfresco-forms-DynamicForm--hidden");
                                    this.alfLog("log", "alfresco_forms_DynamicForm__onDynamicFormUpdate widgets.length", widgets.length);
                                }
                            }
                            catch (e) {
                            ...
                            this.processWidgets(widgetModel, this._form.domNode, "FIELDS");
                        ...
                        if (this.formValueProperty) {
                            ...
                            this.alfLog("log", "alfresco_forms_DynamicForm__onDynamicFormUpdate value", value);
                            if (value) {
                                this.setValue(value);
                            }
                        }
