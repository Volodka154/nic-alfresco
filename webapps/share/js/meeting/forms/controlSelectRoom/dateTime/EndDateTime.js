        ...
        return declare([DateTimeTextBox], {
            ...
            */
        	...
        	postMixInProperties: function () {
                ...
                this.alfSubscribe("MEETING_END_DATE_TIME_UPDATE", lang.hitch(this, this.update), true);   
            ...
            updateTextDateTime: function () {            	
            	this.inherited(arguments);
            	if (!this.noEdit)
            		this.alfPublish("UPDATE_NEW_MEETING_CALENDAR_ROOM", {endTime: this.getCurrentValue()}, true);
            	else
            		this.noEdit=false;
